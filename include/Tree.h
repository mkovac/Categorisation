...
// Sun Jan 14 17:56:00 2018 by ROOT version 6.08/07
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         pConst_HadWH_S_SIG_ghv1_1_MCFM_JECNominal;
   Float_t         p_HadWH_S_SIG_ghv1_1_MCFM_JECNominal;
   Float_t         p_HadWH_S_BSI_ghv1_1_MCFM_JECNominal;
   Float_t         p_HadWH_S_BSI_ghv1_i_MCFM_JECNominal;
   Float_t         p_HadWH_SIG_ghv1_1_MCFM_JECNominal;
   Float_t         p_HadWH_BSI_ghv1_1_MCFM_JECNominal;
   Float_t         p_HadWH_BSI_ghv1_i_MCFM_JECNominal;
   ...
   Float_t         pConst_HadWH_S_SIG_ghv1_1_MCFM_JECUp;
   Float_t         p_HadWH_S_SIG_ghv1_1_MCFM_JECUp;
   Float_t         p_HadWH_S_BSI_ghv1_1_MCFM_JECUp;
   Float_t         p_HadWH_S_BSI_ghv1_i_MCFM_JECUp;
   Float_t         p_HadWH_SIG_ghv1_1_MCFM_JECUp;
   Float_t         p_HadWH_BSI_ghv1_1_MCFM_JECUp;
   Float_t         p_HadWH_BSI_ghv1_i_MCFM_JECUp;
   ...
   Float_t         pConst_HadWH_S_SIG_ghv1_1_MCFM_JECDn;
   Float_t         p_HadWH_S_SIG_ghv1_1_MCFM_JECDn;
   Float_t         p_HadWH_S_BSI_ghv1_1_MCFM_JECDn;
   Float_t         p_HadWH_S_BSI_ghv1_i_MCFM_JECDn;
   Float_t         p_HadWH_SIG_ghv1_1_MCFM_JECDn;
   Float_t         p_HadWH_BSI_ghv1_1_MCFM_JECDn;
   Float_t         p_HadWH_BSI_ghv1_i_MCFM_JECDn;
   ...
   TBranch        *b_pConst_HadWH_S_SIG_ghv1_1_MCFM_JECNominal;   //!
   TBranch        *b_p_HadWH_S_SIG_ghv1_1_MCFM_JECNominal;   //!
   TBranch        *b_p_HadWH_S_BSI_ghv1_1_MCFM_JECNominal;   //!
   TBranch        *b_p_HadWH_S_BSI_ghv1_i_MCFM_JECNominal;   //!
   TBranch        *b_p_HadWH_SIG_ghv1_1_MCFM_JECNominal;   //!
   TBranch        *b_p_HadWH_BSI_ghv1_1_MCFM_JECNominal;   //!
   TBranch        *b_p_HadWH_BSI_ghv1_i_MCFM_JECNominal;   //!
   ...
   TBranch        *b_pConst_HadWH_S_SIG_ghv1_1_MCFM_JECUp;   //!
   TBranch        *b_p_HadWH_S_SIG_ghv1_1_MCFM_JECUp;   //!
   TBranch        *b_p_HadWH_S_BSI_ghv1_1_MCFM_JECUp;   //!
   TBranch        *b_p_HadWH_S_BSI_ghv1_i_MCFM_JECUp;   //!
   TBranch        *b_p_HadWH_SIG_ghv1_1_MCFM_JECUp;   //!
   TBranch        *b_p_HadWH_BSI_ghv1_1_MCFM_JECUp;   //!
   TBranch        *b_p_HadWH_BSI_ghv1_i_MCFM_JECUp;   //!
   ...
   TBranch        *b_pConst_HadWH_S_SIG_ghv1_1_MCFM_JECDn;   //!
   TBranch        *b_p_HadWH_S_SIG_ghv1_1_MCFM_JECDn;   //!
   TBranch        *b_p_HadWH_S_BSI_ghv1_1_MCFM_JECDn;   //!
   TBranch        *b_p_HadWH_S_BSI_ghv1_i_MCFM_JECDn;   //!
   TBranch        *b_p_HadWH_SIG_ghv1_1_MCFM_JECDn;   //!
   TBranch        *b_p_HadWH_BSI_ghv1_1_MCFM_JECDn;   //!
   TBranch        *b_p_HadWH_BSI_ghv1_i_MCFM_JECDn;   //!
...
void Tree::Init(TTree *tree, TString input_file_name)
{
   ...
   if ( !(input_file_name.Contains("AllData")) )
   {
   ...
   fChain->SetBranchAddress("pConst_HadWH_S_SIG_ghv1_1_MCFM_JECNominal", &pConst_HadWH_S_SIG_ghv1_1_MCFM_JECNominal, &b_pConst_HadWH_S_SIG_ghv1_1_MCFM_JECNominal);
   fChain->SetBranchAddress("p_HadWH_S_SIG_ghv1_1_MCFM_JECNominal", &p_HadWH_S_SIG_ghv1_1_MCFM_JECNominal, &b_p_HadWH_S_SIG_ghv1_1_MCFM_JECNominal);
   fChain->SetBranchAddress("p_HadWH_S_BSI_ghv1_1_MCFM_JECNominal", &p_HadWH_S_BSI_ghv1_1_MCFM_JECNominal, &b_p_HadWH_S_BSI_ghv1_1_MCFM_JECNominal);
   fChain->SetBranchAddress("p_HadWH_S_BSI_ghv1_i_MCFM_JECNominal", &p_HadWH_S_BSI_ghv1_i_MCFM_JECNominal, &b_p_HadWH_S_BSI_ghv1_i_MCFM_JECNominal);
   fChain->SetBranchAddress("p_HadWH_SIG_ghv1_1_MCFM_JECNominal", &p_HadWH_SIG_ghv1_1_MCFM_JECNominal, &b_p_HadWH_SIG_ghv1_1_MCFM_JECNominal);
   fChain->SetBranchAddress("p_HadWH_BSI_ghv1_1_MCFM_JECNominal", &p_HadWH_BSI_ghv1_1_MCFM_JECNominal, &b_p_HadWH_BSI_ghv1_1_MCFM_JECNominal);
   fChain->SetBranchAddress("p_HadWH_BSI_ghv1_i_MCFM_JECNominal", &p_HadWH_BSI_ghv1_i_MCFM_JECNominal, &b_p_HadWH_BSI_ghv1_i_MCFM_JECNominal);
   ...
   fChain->SetBranchAddress("pConst_HadWH_S_SIG_ghv1_1_MCFM_JECUp", &pConst_HadWH_S_SIG_ghv1_1_MCFM_JECUp, &b_pConst_HadWH_S_SIG_ghv1_1_MCFM_JECUp);
   fChain->SetBranchAddress("p_HadWH_S_SIG_ghv1_1_MCFM_JECUp", &p_HadWH_S_SIG_ghv1_1_MCFM_JECUp, &b_p_HadWH_S_SIG_ghv1_1_MCFM_JECUp);
   fChain->SetBranchAddress("p_HadWH_S_BSI_ghv1_1_MCFM_JECUp", &p_HadWH_S_BSI_ghv1_1_MCFM_JECUp, &b_p_HadWH_S_BSI_ghv1_1_MCFM_JECUp);
   fChain->SetBranchAddress("p_HadWH_S_BSI_ghv1_i_MCFM_JECUp", &p_HadWH_S_BSI_ghv1_i_MCFM_JECUp, &b_p_HadWH_S_BSI_ghv1_i_MCFM_JECUp);
   fChain->SetBranchAddress("p_HadWH_SIG_ghv1_1_MCFM_JECUp", &p_HadWH_SIG_ghv1_1_MCFM_JECUp, &b_p_HadWH_SIG_ghv1_1_MCFM_JECUp);
   fChain->SetBranchAddress("p_HadWH_BSI_ghv1_1_MCFM_JECUp", &p_HadWH_BSI_ghv1_1_MCFM_JECUp, &b_p_HadWH_BSI_ghv1_1_MCFM_JECUp);
   fChain->SetBranchAddress("p_HadWH_BSI_ghv1_i_MCFM_JECUp", &p_HadWH_BSI_ghv1_i_MCFM_JECUp, &b_p_HadWH_BSI_ghv1_i_MCFM_JECUp);
   ...
   fChain->SetBranchAddress("pConst_HadWH_S_SIG_ghv1_1_MCFM_JECDn", &pConst_HadWH_S_SIG_ghv1_1_MCFM_JECDn, &b_pConst_HadWH_S_SIG_ghv1_1_MCFM_JECDn);
   fChain->SetBranchAddress("p_HadWH_S_SIG_ghv1_1_MCFM_JECDn", &p_HadWH_S_SIG_ghv1_1_MCFM_JECDn, &b_p_HadWH_S_SIG_ghv1_1_MCFM_JECDn);
   fChain->SetBranchAddress("p_HadWH_S_BSI_ghv1_1_MCFM_JECDn", &p_HadWH_S_BSI_ghv1_1_MCFM_JECDn, &b_p_HadWH_S_BSI_ghv1_1_MCFM_JECDn);
   fChain->SetBranchAddress("p_HadWH_S_BSI_ghv1_i_MCFM_JECDn", &p_HadWH_S_BSI_ghv1_i_MCFM_JECDn, &b_p_HadWH_S_BSI_ghv1_i_MCFM_JECDn);
   fChain->SetBranchAddress("p_HadWH_SIG_ghv1_1_MCFM_JECDn", &p_HadWH_SIG_ghv1_1_MCFM_JECDn, &b_p_HadWH_SIG_ghv1_1_MCFM_JECDn);
   fChain->SetBranchAddress("p_HadWH_BSI_ghv1_1_MCFM_JECDn", &p_HadWH_BSI_ghv1_1_MCFM_JECDn, &b_p_HadWH_BSI_ghv1_1_MCFM_JECDn);
   fChain->SetBranchAddress("p_HadWH_BSI_ghv1_i_MCFM_JECDn", &p_HadWH_BSI_ghv1_i_MCFM_JECDn, &b_p_HadWH_BSI_ghv1_i_MCFM_JECDn);
